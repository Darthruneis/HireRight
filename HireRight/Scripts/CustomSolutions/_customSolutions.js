...
(function (CustomSolutions) {
    ...
    (function (Cards) {
        ...
        })(Tests = Cards.Tests || (Cards.Tests = {}));
    })(Cards = CustomSolutions.Cards || (CustomSolutions.Cards = {}));
    var RadioButtons;
    (function (RadioButtons) {
        ...
        RadioButtons.bindEvents = bindEvents;
        ...
        function hideCategoriesFromInactiveIndustries() {
            var activeIndustries = $.makeArray($(".industryToggle.activeIndustry"))
                .map(function (value, index, array) { return $(value); });
            if (activeIndustries.length === 0) {
                $("#categoryContainerDiv .categoryContainer").show();
                return;
            }
            $("#categoryContainerDiv .categoryContainer").each(function (i, elem) {
                var counter = 0;
                var $row = $(elem).find(".row");
                for (i = 0; i < activeIndustries.length; i++) {
                    var industry = activeIndustries[i];
                    var industryName = industry.data("industryname");
    ...
    })(RadioButtons = CustomSolutions.RadioButtons || (CustomSolutions.RadioButtons = {}));
    function bindCategoryTitleToToggle() {
        $(".categoryDescriptionToggle").on("click", function (e) {
            ...
            var $description = $container.find(".categoryDescription");
            $description.toggle();
        });
    }
